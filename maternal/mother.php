...
<h1 style ="color:grey">Maternal Advisory system</h1>
<div class="login-container">
  <section class="login" id="login">
    <header>
       
     <h1><p>Insert maternal problem and solution</p></h1>
    </header>   
 ...
 <form action="" method="post">
   ...
   Maternal Problem<br/>
   <input type="text" name="problem" class="login-input"><br/>
   Solution to problem <br/>
   <input type="text" name="solution" class="login-input" ><br/>
...
if(isset($_POST["submit"])) {
  ...
  $problem2 = strtolower($_POST['problem']);
  $solution = $_POST['solution'];
  
  //strtolower($messageText);

  $problem = $problem2." "."add";
...
$str_arr = str_split( $ssp);
 ...
 $prob = implode($str_arr);
  ...
  $sql = "INSERT INTO solve (problem, soln, soln2)
      VALUES ('$problem', '$solution', '$prob')";

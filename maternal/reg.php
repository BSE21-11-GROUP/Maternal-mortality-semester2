...
if(isset($_POST["submit"])) { 
  ...
  /* here it is really happening */
		  ...
		  $sql = "INSERT INTO mothers (mother, contact,location, email, time, status, age)VALUES ('$mother','$contact',
		  '$location','$email','$time','$status','$age' )";
...
<div class="login-container">
  <section class="login" id="login">
    <header><br/> Insert pregnant mother details</header>

<form enctype="multipart/form-data" method="post" action=""  class="login-form">

<input type="text" name="mother" placeholder="Mother's Name" class="login-input" autofocus />


<input type="text" name="status" placeholder="Status"  class="login-input" autofocus />


<input type="text" name="contact" placeholder="Contact" class="login-input" autofocus />

<input type="text" name="location" placeholder="Location" class="login-input" autofocus />

<input type="text" name="email" placeholder="Email" class="login-input" autofocus />

<input type="text" name="time" placeholder="Time left" class="login-input" autofocus />

<input type="text" name="age" placeholder="Age" class="login-input" autofocus />
